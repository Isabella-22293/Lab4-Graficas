...
impl Color {
    ...
    // Interpolación cuadrática entre dos colores
    pub fn quadratic_lerp(&self, other: &Color, t: f32) -> Self {
        let t = t.clamp(0.0, 1.0);
        let t_squared = t * t;
        Color {
            r: (self.r as f32 + (other.r as f32 - self.r as f32) * t_squared).round() as u8,
            g: (self.g as f32 + (other.g as f32 - self.g as f32) * t_squared).round() as u8,
            b: (self.b as f32 + (other.b as f32 - self.b as f32) * t_squared).round() as u8,
        }
    }
}
